const ThemesAppearance = {
  Light: (props: React.HTMLAttributes<HTMLDivElement>) => (
    <div
      className="items-center rounded-md border-2 border-muted p-1 hover:border-accent cursor-pointer"
      {...props}
    >
  ...
  Dark: (props: React.HTMLAttributes<HTMLDivElement>) => (
    <div
